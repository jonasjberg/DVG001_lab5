...
hantera användare ordentligt och fördela resurser baserat på användare andra än
användaren \texttt{nobody} och gruppen \texttt{nogroup}.
Detta enligt lab-instruktionerna \cite{dvg001:instruktionerLab5}, 
